 ...
 * @param {String} url Image URL
 */
async function takesticker1(img, url) {
 ...
 */
async function takesticker3(img, url, packname, author) {
...
module.exports = {
   ...
   * @param {...String} 
   */
  async takesticker(img, url, ...args) {
    let lastError
    for (let func of [takesticker3, takesticker2, takesticker1]) {
      try {
